...
describe(FunctionCallsMerger, () =>
{
    ...
    const hashToFunctionInfoMap = new Map([
        [functionInfoA.getHash(), functionInfoA],
        [functionInfoB.getHash(), functionInfoB],
        [functionInfoC.getHash(), functionInfoC],
        [functionInfoD.getHash(), functionInfoD],
    ]);
    ...
    it('should not merge FunctionCalls whose callers are different', function ()
    {
        ...
        const functionCallsMerger = new FunctionCallsMerger(hashToFunctionInfoMap, [functionCallA, functionCallB], [functionCallC]);
    ...
    it('should merge callee correctly with duplicates', function ()
    {
        ...
        const functionCallsMerger = new FunctionCallsMerger(hashToFunctionInfoMap, [functionCallA, functionCallB], [functionCallC, functionCallD]);
        const mergedFunctionCalls = functionCallsMerger.getMergedFunctionCalls();
        // .toContainEqual is not working here
        expect(JSON.stringify(mergedFunctionCalls.sort())).toBe(JSON.stringify([
